...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo _WEB_ROOT ?>/admin/DashBoard">
                ...
                <div id="collapseQLSanPham" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-gradient-success py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo _WEB_ROOT ?>/admin/product/addproduct">Thêm sản
                            phẩm</a>
                        <a class="collapse-item" href="<?php echo _WEB_ROOT ?>/admin/product/recycleproduct">Khôi phục sản
                            phẩm</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseQLNguoiDung" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-gradient-success py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo _WEB_ROOT ?>/admin/customer/addCustomer">Thêm khách hàng</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseQLPhieuNhap" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-gradient-success py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo _WEB_ROOT ?>/admin/productReceipt/addReceipt">Thêm phiếu nhập</a>
                    </div>
                </div>
            </li>

                    ...
                    <div class="col-md-12 col-lg-6 col-xl-7">
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" class="form-control" name="TenKH"
                                value="<?php if (isset($_SESSION['user'])) {
                                    ...
                                    echo !empty($old["TenKH"]) ? $old["TenKH"] : '';
                                } ?>">
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" class="form-control" name="DiaChi"
                                value="<?php if (isset($_SESSION['user'])) {
                                    ...
                                    echo !empty($old["DiaChi"]) ? $old["DiaChi"] : '';
                                } ?>">
                        ...
                        <div class="row g-4 text-center align-items-center justify-content-center border-bottom">
                            <button type="submit" name="redirect"
                                class="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary">Thanh toán qua
                                Vnpay</button>
                        </div>
                        <div class="row g-4 text-center align-items-center justify-content-center pt-4">
                            <button type="submit" name=""
                                class="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary">Thanh toán khi nhận
                                hàng</button>
                        </div>
                    </div>

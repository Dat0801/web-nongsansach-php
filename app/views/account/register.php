...
<head>
    ...
    <link href="<?php echo _WEB_ROOT ?>/public/assets/admin/Content/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="text-center">
                                <a class="small" href="login.html">Bạn đã có tài khoản? Hãy quay lại trang đăng nhập!</a>
                            </div>
                        </div>
                    </div>
                </div>

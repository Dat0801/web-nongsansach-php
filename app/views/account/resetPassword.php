                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="<?php echo _WEB_ROOT ?>/Account/resetPassword" method="POST" class="user">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <?php echo (!empty($errors) && array_key_exists('ConfirmPassword', $errors)) ? '<span class="text-danger">' . $errors["ConfirmPassword"] . '</span>' : false; ?>
                                        </div>

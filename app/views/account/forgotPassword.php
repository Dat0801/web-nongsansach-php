                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="<?php echo _WEB_ROOT ?>/Account/forgotpassword" method="POST" class="user">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block form-control" style="margin: 0 auto">
                                            Gửi yêu cầu
                                        </button>
                                    </form>
                                    <hr>
